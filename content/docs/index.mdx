...
<Callout title="Privacy by default">
  ...
  MongoDB. Web search is the only feature that leaves your network, and it stays
...
| **Web search**    | [Tavily](/docs/web-search), optional and opt-in |
...
<Cards>
  ...
  <Card
    icon={<Globe />}
    title="Web search"
    description="Tavily, with cited sources. Off until you switch it on."
